...
const QString BITCOIN_IPC_PREFIX("Yutecoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Yutecoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Yutecoin: click-to-pay handler");
    else
...
{
    // clicking on Yutecoin: URLs creates FileOpen events on the Mac:
