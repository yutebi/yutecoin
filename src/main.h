...
public:
    ...
    {
        // Yutecoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Yutecoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Yutecoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Yutecoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Yutecoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Yutecoin: block index flags
    enum  
    {
